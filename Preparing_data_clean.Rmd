...
The postal code areas in the data from Westland Infra can spa multiple PC6 postal codes. First we select all of the PC6 postal codes in the CBS data that are contained in the postal code ranges of the Westland Infra data.
