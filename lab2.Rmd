...
cbs_500 <- bind_rows(cbs_500_24, cbs_500_23, cbs_500_22, cbs_500_21, cbs_500_20, cbs_500_19, cbs_500_18, cbs_500_17, cbs_500_16, cbs_500_15) |>
  ...
  select(crs28992res500m, gemiddeld_inkomen_huishouden, percentage_laag_inkomen_huishouden, percentage_hoog_inkomen_huishouden, M_INKHH, omgevingsadressendichtheid, stedelijkheid, geom, year)|>
  
  relocate(crs28992res500m, geom, year, gemiddeld_inkomen_huishouden, percentage_laag_inkomen_huishouden, percentage_hoog_inkomen_huishouden, M_INKHH, omgevingsadressendichtheid, stedelijkheid) |>
...
df <- df |>
  ...
  select(-c(year.y, gemiddeld_inkomen_huishouden, percentage_laag_inkomen_huishouden, percentage_hoog_inkomen_huishouden, omgevingsadressendichtheid, stedelijkheid, M_INKHH))
...
```{r eval=FALSE}
st_write(df, "./data/merged_data.gpkg")
